...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 CHAU
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 CHAU mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 10131400000 * COIN; // int64 = 9223372036854775807(MAX)
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 720 / 250; //1day = 720 blocks = 30 block/hour * 24 hour 
    }
